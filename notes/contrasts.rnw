\documentclass{/home/bolker/classes/stat4c03/notes/tufte-handout}
%% HACK: version of tufte-handout that allows multicolor tables
%%  need full path for tikz machinery
\usepackage{url}
\usepackage{hyperref}
